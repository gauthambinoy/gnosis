...
ONBOARDING_STEPS = [
    {
        ...
        "description": "Your AI agent platform is ready",
    },
    {
        "id": "create_agent",
        "title": "Create Your First Agent",
        "description": "Describe what you need and Gnosis builds it",
    },
    {
        "id": "first_execution",
        "title": "Run Your First Task",
        "description": "See your agent in action",
    },
    {
        "id": "explore_memory",
        "title": "Explore Agent Memory",
        "description": "See how your agent learns and remembers",
    },
    {
        "id": "connect_llm",
        "title": "Connect Your LLM",
        "description": "Add your OpenRouter or API key",
    },
    {
        "id": "invite_team",
        "title": "Invite Your Team",
        "description": "Collaborate on agents and workflows",
    },
]
...
async def get_onboarding_status(user_id: str = Depends(get_current_user_id)):
    ...
    steps = [
        {**step, "completed": step["id"] in completed_ids} for step in ONBOARDING_STEPS
    ]
