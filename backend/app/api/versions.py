...
@router.get("/current")
async def get_current_version(agent_id: str):
...
async def get_version(agent_id: str, version_id: str):
...
async def rollback_version(agent_id: str, version_id: str):
...
async def diff_versions(agent_id: str, version_a: str, version_b: str):
