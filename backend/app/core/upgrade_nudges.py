    ...
    def evaluate_nudges(self, user_id: str) -> List[dict]:
        nudges = [
            Nudge(
                ...
                message="You've used 80% of your monthly executions",
                action_url="/billing",
                priority=3,
            ),
            Nudge(
                id="nudge-feature",
                type="feature_unlock",
                title="Try Agent Pipelines",
                message="Chain agents together for complex workflows",
            ...
            Nudge(
                ...
                type="feature_unlock",
                title="Enable Memory",
                message="Your agents can learn from past interactions",
                action_url="/settings",
                priority=1,
            ),
            Nudge(
                ...
                message="Protect sensitive data automatically",
                action_url="/security",
                priority=2,
            ),
        ]
