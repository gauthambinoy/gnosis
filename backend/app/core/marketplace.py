...
CATEGORIES = [
    ...
    },
    {
        ...
        "name": "Development",
        "icon": "🛠️",
        "description": "Code review, CI/CD, DevOps",
    },
    {
        "id": "creative",
        "name": "Creative",
        "icon": "🎨",
        "description": "Content generation & design",
    },
    {
        "id": "finance",
        "name": "Finance",
        "icon": "💰",
        "description": "Budgeting, invoicing, tracking",
    },
    {
        "id": "hr",
        "name": "HR & Recruitment",
        "icon": "👥",
        "description": "Hiring, onboarding, feedback",
    },
    {
        "id": "custom",
        "name": "Custom",
        "icon": "🔧",
        "description": "User-created workflows",
    },
]
...
class MarketplaceEngine:
    def __init__(self):
        ...
        self._reviews: Dict[
            str, List[AgentReview]
        ] = {}  # marketplace_agent_id -> reviews
    ...
    def _seed_marketplace(self):
        ...
        starters = [
            {
                ...
                "description": "Summarizes daily emails into actionable bullet points",
                "category": "communication",
                "tags": ["email", "summary", "daily"],
                "featured": True,
                "config": {
                    "persona": "You are an email analyst. Summarize emails concisely.",
                    "model_tier": "fast",
                    "integrations": ["gmail"],
                },
            },
            {
                ...
                "featured": True,
                "config": {
                    "persona": "You are a senior code reviewer. Focus on bugs, security, performance.",
                    "model_tier": "standard",
                    "integrations": ["github"],
                },
            },
            {
                ...
                "description": "Generates structured meeting notes with action items",
                "category": "productivity",
                "tags": ["meetings", "notes", "action-items"],
                "featured": True,
                "config": {
                    "persona": "You convert meeting transcripts into structured notes with action items.",
                    "model_tier": "fast",
                },
            },
            {
                "name": "Data Pipeline Monitor",
                "description": "Monitors data pipelines and alerts on anomalies",
                "category": "data",
                "tags": ["monitoring", "alerts", "data"],
                "config": {
                    "persona": "You monitor data pipeline metrics and flag anomalies.",
                    "model_tier": "standard",
                },
            },
            {
                "name": "Social Media Composer",
                "description": "Creates engaging social media posts from briefs",
                "category": "creative",
                "tags": ["social", "content", "marketing"],
                "config": {
                    "persona": "You craft engaging social media posts. Be creative, concise, and on-brand.",
                    "model_tier": "standard",
                },
            },
            {
                "name": "Invoice Processor",
                "description": "Extracts data from invoices and categorizes expenses",
                "category": "finance",
                "tags": ["invoices", "expenses", "extraction"],
                "config": {
                    "persona": "You extract structured data from invoices: vendor, amount, date, category.",
                    "model_tier": "fast",
                },
            },
        ]
        for s in starters:
            agent = MarketplaceAgent(
                ...
                author="Gnosis Team",
                rating=4.5 + (hash(s["name"]) % 5) / 10,
                rating_count=10 + hash(s["name"]) % 40,
    ...
    def publish(
        ...
        sanitized_config = {
            ...
            if k not in ("api_keys", "secrets", "tokens")
        }
        agent = MarketplaceAgent(
            id=str(uuid.uuid4()),
            name=name,
    ...
    def browse(
        ...
        agents.sort(
            key=sort_fns.get(sort_by, sort_fns["popular"]), reverse=sort_by != "name"
        )
    ...
    def add_review(
        self, marketplace_agent_id: str, user_id: str, rating: int, comment: str = ""
