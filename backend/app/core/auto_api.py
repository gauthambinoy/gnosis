...
API_CATALOG = {
    ...
    "github": {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/search/repositories", "description": "Search repos"},
        ],
        "category": "developer",
    },
    "slack": {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/conversations.history", "description": "Channel messages"},
    ...
    "notion": {
        ...
        "endpoints": [
            ...
            {"method": "POST", "path": "/databases/{id}/query", "description": "Query database"},
    ...
    "openai": {
        ...
        "endpoints": [
            ...
            {"method": "POST", "path": "/audio/transcriptions", "description": "Transcribe audio"},
    ...
    "twilio": {
        ...
        "endpoints": [
            {"method": "POST", "path": "/Accounts/{sid}/Messages.json", "description": "Send SMS"},
            {"method": "POST", "path": "/Accounts/{sid}/Calls.json", "description": "Make call"},
            {"method": "GET", "path": "/Accounts/{sid}/Messages.json", "description": "List messages"},
        ],
        "category": "communication",
    },
    "shopify": {
        ...
        "endpoints": [
            ...
            {"method": "POST", "path": "/products.json", "description": "Create product"},
        ],
        "category": "ecommerce",
    },
    "sendgrid": {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/contactdb/recipients", "description": "List contacts"},
    ...
    "google_sheets": {
        ...
        "endpoints": [
            {"method": "GET", "path": "/spreadsheets/{id}", "description": "Get spreadsheet"},
            {"method": "GET", "path": "/spreadsheets/{id}/values/{range}", "description": "Read cells"},
            {"method": "PUT", "path": "/spreadsheets/{id}/values/{range}", "description": "Write cells"},
            {"method": "POST", "path": "/spreadsheets/{id}/values/{range}:append", "description": "Append rows"},
        ],
        "category": "productivity",
    },
    "weather": {
        ...
        "endpoints": [
            {"method": "GET", "path": "/weather?q={city}", "description": "Current weather"},
            {"method": "GET", "path": "/forecast?q={city}", "description": "5-day forecast"},
            {"method": "GET", "path": "/air_pollution?lat={lat}&lon={lon}", "description": "Air quality"},
        ],
        "category": "data",
    },
    "airtable": {
        ...
        "endpoints": [
            {"method": "GET", "path": "/{baseId}/{tableName}", "description": "List records"},
            {"method": "POST", "path": "/{baseId}/{tableName}", "description": "Create record"},
            {"method": "PATCH", "path": "/{baseId}/{tableName}", "description": "Update records"},
            {"method": "DELETE", "path": "/{baseId}/{tableName}", "description": "Delete records"},
        ],
        "category": "productivity",
    },
    "hubspot": {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/crm/v3/objects/companies", "description": "List companies"},
        ],
        "category": "crm",
    },
}
...
class AutoAPIEngine:
    ...
    def connect(self, api_name: str, api_key: str, extra_config: dict = None) -> dict:
        ...
        if not api_info:
            return {"error": f"Unknown API: {api_name}. Use search to find available APIs."}
            ...
            async with aiohttp.ClientSession(timeout=timeout) as session:
                async with session.get(url, headers=headers) as resp:
                    ...
                    if status in (200, 201):
                        ...
                        conn.status = "failed"
                        return {"status": "auth_failed", "http_status": status, "message": "Invalid API key"}
                    else:
    ...
    async def call_api(self, connection_id: str, endpoint_path: str, method: str = "GET", body: dict = None, params: dict = None) -> dict:
        ...
        if conn.auth_type == "bearer":
            ...
            header_name = api_info.get("auth_header", "Authorization") if api_info else "Authorization"
            headers[header_name] = f"{prefix} {conn.api_key}"
        elif conn.auth_type == "header":
            header_name = api_info.get("auth_header", "X-Api-Key") if api_info else "X-Api-Key"
            headers[header_name] = conn.api_key
        elif conn.auth_type == "query_param":
            param_name = api_info.get("auth_param", "api_key") if api_info else "api_key"
    ...
    def list_connections(self) -> list[dict]:
        return [asdict(c) for c in sorted(self._connections.values(), key=lambda c: c.created_at, reverse=True)]
