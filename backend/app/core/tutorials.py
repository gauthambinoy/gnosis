...
BUILTIN_TUTORIALS = [
    Tutorial(
        ...
        description="Learn how to create and configure an AI agent from scratch",
        category="getting-started",
        difficulty="beginner",
        estimated_minutes=5,
        steps=[
            {
                "title": "Navigate to Agent Factory",
                "content": "Click on the Factory tab in the sidebar",
                "action_type": "navigate",
                "target": "/factory",
            },
            {
                "title": "Choose Agent Type",
                "content": "Select a base template for your agent",
                "action_type": "click",
                "target": "agent-type-selector",
            },
            {
                "title": "Configure Persona",
                "content": "Set the agent's name, description, and personality",
                "action_type": "input",
                "target": "agent-config-form",
            },
            {
                "title": "Test Your Agent",
                "content": "Send a test message to verify it works",
                "action_type": "input",
                "target": "agent-chat",
            },
        ],
    ...
    Tutorial(
        ...
        description="Chain multiple agents to handle complex workflows",
        ...
        steps=[
            {
                ...
                "content": "Navigate to the Pipelines section",
                "action_type": "navigate",
                "target": "/pipelines",
            },
            {
                "title": "Create Pipeline",
                "content": "Click 'New Pipeline' and give it a name",
                "action_type": "click",
                "target": "new-pipeline-btn",
            },
            {
                "title": "Add Steps",
                "content": "Drag agents to build your pipeline flow",
                "action_type": "click",
    ...
    Tutorial(
        ...
        description="Understand the 4-tier memory architecture",
        category="advanced",
        difficulty="intermediate",
        estimated_minutes=8,
        steps=[
            {
                ...
                "content": "Gnosis uses 4 memory tiers: Correction > Episodic > Semantic > Procedural",
                "action_type": "observe",
                "target": "memory-panel",
            },
            {
                "title": "Store a Memory",
                "content": "Create a semantic memory entry manually",
                "action_type": "input",
                "target": "memory-form",
            },
        ],
    ...
    Tutorial(
        ...
        description="Secure your agents and data",
        category="security",
        difficulty="beginner",
        estimated_minutes=5,
        steps=[
            {
                ...
                "content": "Each agent has trust levels 0-3",
                "action_type": "observe",
                "target": "trust-settings",
            },
            {
                "title": "Enable PII Detection",
                "content": "Turn on PII redaction for sensitive data",
                "action_type": "click",
                "target": "pii-toggle",
            },
        ],
        ...
        steps=[
            {
                ...
                "content": "Customize the system prompt for precise control",
                "action_type": "input",
                "target": "system-prompt-editor",
            },
            {
                "title": "Temperature Tuning",
                "content": "Adjust temperature for creativity vs consistency",
                "action_type": "input",
